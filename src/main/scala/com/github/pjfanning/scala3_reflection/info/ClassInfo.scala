...
import com.github.pjfanning.scala3_reflection.util.ClassUtil
import impl.*
...
trait ScalaClassInfoBase extends ClassInfo:
  ...
  def show(tab:Int = 0, seenBefore: List[String] = Nil, suppressIndent: Boolean = false, modified: Boolean = false): String =
    ...
    if seenBefore.contains(name) then
      ...
      + {if annotations.filterNot((k,_)=>k == "com.github.pjfanning.scala3_reflection.S3Reflection").nonEmpty then tabs(newTab) + "annotations: "+annotations.filterNot((k,_)=>k == "com.github.pjfanning.scala3_reflection.S3Reflection").toString + "\n" else ""}
...
case class ScalaCaseClassInfo protected[scala3_reflection] (
    name:                   String,
    fullName:               String,
...
case class ScalaClassInfo protected[scala3_reflection] (
    name:                   String,
    fullName:               String,
    paramSymbols:           Array[TypeSymbol],
    _typeMembers:           Array[TypeMemberInfo],
...
case class JavaClassInfo protected[scala3_reflection] ( 
    name:          String, 
    fullName:      String,
    paramSymbols:  Array[TypeSymbol],
...
case class JavaClassInfoProxy protected[scala3_reflection] (
    name:                   String,
    _fields:                Array[FieldInfo],
    _annotations:           Map[String, Map[String,String]],
