...
case class ScalaEnumInfo protected[scala3_reflection](
  name: String,
  values: Array[String]
) extends EnumInfo: 
  val fullName = name
...
case class ScalaEnumerationInfo protected[scala3_reflection](
  name: String,
  values: Array[String]
) extends EnumInfo:
  val fullName = name
...
case class JavaEnumInfo protected[scala3_reflection](
  name: String,
) extends RType: 
  val fullName = name
  lazy val infoClass: Class[_] = Class.forName(name)
