...
class Eithers extends munit.FunSuite:
  ...
  test("Scala simple Either field") {
    ...
    assertEquals( result.show(), """ScalaCaseClassInfo(com.github.pjfanning.scala3_reflection.BothSides):
    |   fields:
    |      (0) a: Either:
    |         left--scala.Int
  ...
  test("Scala Either with Option") {
    ...
    assertEquals( result.show(), """ScalaCaseClassInfo(com.github.pjfanning.scala3_reflection.BothSidesWithOption):
    |   fields:
    |      (0) a: Either:
    |         left--scala.Int
  ...
  test("Scala Either with Union type") {
    ...
    assertEquals( result.show(), """ScalaCaseClassInfo(com.github.pjfanning.scala3_reflection.BothSidesWithUnion):
    |   fields:
    |      (0) a: Either:
    |         left--scala.Int
    |         right--Union:
  ...
  test("Scala Either having a parameterized type") {
    ...
    assertEquals( result.show(), """ScalaCaseClassInfo(com.github.pjfanning.scala3_reflection.BothSidesParam):
    |   fields:
    |      (0) a: Either:
    |         left--scala.Int
    |         right--Option of ScalaCaseClassInfo(com.github.pjfanning.scala3_reflection.ParamOption):
    |            fields:
