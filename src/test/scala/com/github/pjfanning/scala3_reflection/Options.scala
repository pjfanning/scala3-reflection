...
class Options extends munit.FunSuite:
  ...
  test("Scala optional field") {
    ...
    assertEquals( result.show(), """ScalaCaseClassInfo(com.github.pjfanning.scala3_reflection.NormalOption):
    |   fields:
  ...
  test("Java optional field") {
    val result = RType.of[com.github.pjfanning.scala3_reflection.JavaOption1]
    assertEquals( result.show(), """JavaClassInfo(com.github.pjfanning.scala3_reflection.JavaOption1):
    |   fields:
  ...
  test("Scala nested optional field") {
    ...
    assertEquals( result.show(), """ScalaCaseClassInfo(com.github.pjfanning.scala3_reflection.NestedOption):
    |   fields:
  ...
  test("Java nested optional field") {
    val result = RType.of[com.github.pjfanning.scala3_reflection.JavaOption2]
    assertEquals( result.show(), """JavaClassInfo(com.github.pjfanning.scala3_reflection.JavaOption2):
    |   fields:
  ...
  test("Scala optional parameterized field") {
    ...
    assertEquals( result.show(), """ScalaCaseClassInfo(com.github.pjfanning.scala3_reflection.ParamOption):
    |   fields:
  ...
  test("Java optional parameterized field") {
    val result = RType.of[com.github.pjfanning.scala3_reflection.JavaOption3[Char]]
    assertEquals( result.show(), """JavaClassInfo(com.github.pjfanning.scala3_reflection.JavaOption3):
    |   fields:
  ...
  test("Option of a union") {    
    ...
    assertEquals( result.show(), """ScalaCaseClassInfo(com.github.pjfanning.scala3_reflection.OptionHavingUnion):
    |   fields:
    |      (0) a: Option of Union:
    |         left--scala.Boolean
